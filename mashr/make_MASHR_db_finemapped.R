...
#mashr_in <- fread("~/mashr/MASHR_outputs/cis_trans/no_missingdata/ENSG00000171489_MASHR_beta.txt") %>% select(gene, snps, snp_ID, contains("euro")) #%>% inner_join(top_SNPs_df, by=c('gene', 'snp_ID'))

#Function to correct strand flips from top_SNPs_df with mashr as reference 
